...
export default function BuyIcon({ variant, ...props }: BuyIconProps) {
  return (
    <svg
      width="42px"
      height="42px"
    ...
    >
      <defs>
        ...
        >
          <stop
            stop-color={variant === 'blue' ? '#0AD4FA' : '#FFFFFF'}
            offset="0%"
          ></stop>
          <stop
            stop-color={variant === 'blue' ? '#25BBF1' : '#FFFFFF'}
            offset="100%"
          ></stop>
        </radialGradient>
      </defs>
              ...
              <g id="product-card" transform="translate(0.000000, 12.000000)">
                <g id="Icon" transform="translate(222.000000, 12.000000)">
                  <g>
                    <circle
                      id="Oval-Copy-5"
                      fill={variant === 'blue' ? '#0AD4FA' : '#FFFFFF'}
                      r="21"
                      cx="50%"
                      cy="50.8764901%"
                      fx="50%"
                    ...
                    <path
                      ...
                      id="Shape-Copy-2"
                      fill={variant === 'blue' ? '#FFFFFF' : '#25BBF1'}
                      fill-rule="nonzero"
                    ></path>
                  </g>
                </g>
